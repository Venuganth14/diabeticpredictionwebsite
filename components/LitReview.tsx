...
const LiteratureReview = () => {
  return (
    <Card className="max-w-5xl mx-auto mt-8">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Literature Review: Diabetes Risk Assessment</CardTitle>
      </CardHeader>
      <CardContent>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">1. Neck Circumference</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">2. Foot Ulcers</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">3. Nail Health</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">4. Diabetic Retinopathy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">5. Machine Learning&#39;s Role</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mb-2">6. User Accessibility</h2>
        <p className="mb-4">
        ...
        <h1 className="text-2xl font-bold mt-8 mb-4">References</h1>
